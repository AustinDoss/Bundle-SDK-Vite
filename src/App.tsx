...
function App() {
  return (
    <div className="App">
      <iframe id={'showcase_iframe'} width={'800px'} height={'600px'} frameBorder={0} src={`./mp_bundle/showcase.html?m=j4RZx7ZGM6T&applicationKey=${sdkKey}&play=1`} onLoad={handleShowcaseLoad}></iframe>
    </div>
  )
}
